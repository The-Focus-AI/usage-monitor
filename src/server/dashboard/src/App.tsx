...
import type { Client, UsageCheck } from "./api.js";
import {
	fetchClients,
	fetchClientUsage,
	triggerCheck,
	...
	return (
		<div className="grid grid-cols-1 gap-px bg-[#1a1a1a] border border-[#1a1a1a]">
			<div className="bg-[#f3f2ea] px-4 py-3 md:px-6 md:py-4 font-mono text-[10px] font-bold uppercase tracking-[0.15em] text-[#0055aa] flex items-center gap-4 border-b border-[#1a1a1a]/20">
				...
				<span className="w-16 text-right hidden sm:block">Providers</span>
			...
			{clients.map((client) => (
				<button
					...
					className="bg-white p-4 md:p-6 hover:bg-[#f8f8f6] transition-colors text-left w-full cursor-pointer"
				>
					<div className="flex items-center gap-4">
						...
						<div className="w-16 text-right font-mono text-[11px] text-[#1a1a1a]/40 hidden sm:block">
							—
						</div>
